...
```
+
image::http://callistaenterprise.se/assets/blogg/goblog/part7-clientsidelb.png[]
...
+
[with=50%]
image::http://callistaenterprise.se/assets/blogg/goblog/part7-serversidelb.png[]
...
image::https://istio.io/docs/concepts/what-is-istio/img/overview/arch.svg[]
